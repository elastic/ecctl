## ecctl deployment elasticsearch resync

Resynchronizes the search index and cache for the selected Elasticsearch cluster
...
```
ecctl deployment elasticsearch resync <cluster id> [flags]
```
