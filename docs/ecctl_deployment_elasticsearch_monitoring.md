...
* [ecctl deployment elasticsearch monitoring enable](ecctl_deployment_elasticsearch_monitoring_enable.md)	 - Enables monitoring in the cluster <monitored cluster id>, sending data to the cluster <monitoring cluster id>
