	...
	tests := []struct {
		...
		},
		{
			...
			args: testutils.Args{
				Cmd: deleteCmd,
				Args: []string{
					"delete", "11111111111111111111111111111111", "--deployment-id", "11",
				},
				Cfg: testutils.MockCfg{Responses: []mock.Response{
					mock.SampleInternalError(),
				}},
		...
		},
		{
			...
			args: testutils.Args{
				Cmd: deleteCmd,
				Args: []string{
					"delete", "a8b649146d4149479b03c2076886e4de", "--deployment-id", "0a1214498c68421ca09908545a0e25ca",
				},
					...
					Responses: []mock.Response{
						mock.New200ResponseAssertion(
							&mock.RequestAssertion{
								...
								Method: "DELETE",
								Path:   "/api/v1/deployments/traffic-filter/rulesets/a8b649146d4149479b03c2076886e4de/associations/deployment/0a1214498c68421ca09908545a0e25ca",
