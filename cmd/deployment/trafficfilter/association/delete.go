...
func initDeleteFlags() {
	...
	deleteCmd.Flags().String("deployment-id", "", "Required deployment ID where the traffic filter is associated")
	cobra.MarkFlagRequired(deleteCmd.Flags(), "deployment-id")
}
